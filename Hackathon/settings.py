...
SECRET_KEY = 'django-insecure-+ug-xn4m-4c!)pix47+68dr)-&9zwy_-1qai@0+1dkb$@9k+)s'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],   # adds the path to the templates folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
MEDIA_URL = '/media/'
# adding paths for taking images
